...
public class AccountController {
    ...
    public Account listAccountByUserId(@PathVariable("id") int userId) throws AccountNotFound {
    ...
    public int giveUserIdForAccount(@PathVariable ("id") int accountId) {
        return accountDao.getUserIdAssociatedWithAccount(accountId);
    }
}
