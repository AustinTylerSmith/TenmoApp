...
public class AuthenticationService {
    ...
    public String login(String username, String password) {
        ...
        try {
            ...
            System.out.println("Error login method");
        }
        return token;
    }
    ...
    public void register(RegisterUserDTO user) {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<RegisterUserDTO> entity = new HttpEntity<>(user, headers);
        try {
             restTemplate.postForObject(API_BASE_URL + "register", entity, Void.class);
        } catch (RestClientResponseException | ResourceAccessException e) {
            System.out.println(e.getMessage());
        }
    }

    public String getCredentialsDtoUsername() {
